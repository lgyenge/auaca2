...
export const loadAuItems = createAction('[AuItem/API] Load AuItems', props<{ templateId: string }>());
export const loadAuItemsSuccess = createAction('[AuItems/API] Load AuItems Success', props<{ AuItems: AuItem[] }>());
